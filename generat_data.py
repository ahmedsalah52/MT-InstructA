...
generator = Generate_data(meta_env,os.path.join(args.project_dir,args.data_dir),args.agents_dir,args.tasks,args.train_data_total_steps,args.agents_dict_dir,args.agent_levels)
