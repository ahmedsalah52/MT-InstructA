...
import metaworld.envs.mujoco.sawyer_xyz_original.v2 as orignal_env

ALL_V2_ENVIRONMENTS = OrderedDict((
    ('assembly-v2', orignal_env.SawyerNutAssemblyEnvV2),
    ('basketball-v2', orignal_env.SawyerBasketballEnvV2),
    ('bin-picking-v2', orignal_env.SawyerBinPickingEnvV2),
    ('box-close-v2', orignal_env.SawyerBoxCloseEnvV2),
    ('button-press-topdown-v2', orignal_env.SawyerButtonPressTopdownEnvV2),
    ('button-press-topdown-wall-v2', orignal_env.SawyerButtonPressTopdownWallEnvV2),
    ('button-press-v2', orignal_env.SawyerButtonPressEnvV2),
    ('button-press-wall-v2', orignal_env.SawyerButtonPressWallEnvV2),
    ('coffee-button-v2', orignal_env.SawyerCoffeeButtonEnvV2),
    ('coffee-pull-v2', orignal_env.SawyerCoffeePullEnvV2),
    ('coffee-push-v2', orignal_env.SawyerCoffeePushEnvV2),
    ('dial-turn-v2', orignal_env.SawyerDialTurnEnvV2),
    ('disassemble-v2', orignal_env.SawyerNutDisassembleEnvV2),
    ('door-close-v2', orignal_env.SawyerDoorCloseEnvV2),
    ('door-lock-v2', orignal_env.SawyerDoorLockEnvV2),
    ('door-open-v2', orignal_env.SawyerDoorEnvV2),
    ('door-unlock-v2', orignal_env.SawyerDoorUnlockEnvV2),
    ('hand-insert-v2', orignal_env.SawyerHandInsertEnvV2),
    ('drawer-close-v2', orignal_env.SawyerDrawerCloseEnvV2),
    ('drawer-open-v2', orignal_env.SawyerDrawerOpenEnvV2),
    ('faucet-open-v2', orignal_env.SawyerFaucetOpenEnvV2),
    ('faucet-close-v2', orignal_env.SawyerFaucetCloseEnvV2),
    ('hammer-v2', orignal_env.SawyerHammerEnvV2),
    ('handle-press-side-v2', orignal_env.SawyerHandlePressSideEnvV2),
    ('handle-press-v2', orignal_env.SawyerHandlePressEnvV2),
    ('handle-pull-side-v2', orignal_env.SawyerHandlePullSideEnvV2),
    ('handle-pull-v2', orignal_env.SawyerHandlePullEnvV2),
    ('lever-pull-v2', orignal_env.SawyerLeverPullEnvV2),
    ('peg-insert-side-v2', orignal_env.SawyerPegInsertionSideEnvV2),
    ('pick-place-wall-v2', orignal_env.SawyerPickPlaceWallEnvV2),
    ('pick-out-of-hole-v2', orignal_env.SawyerPickOutOfHoleEnvV2),
    ('reach-v2', orignal_env.SawyerReachEnvV2),
    ('push-back-v2', orignal_env.SawyerPushBackEnvV2),
    ('push-v2', orignal_env.SawyerPushEnvV2),
    ('pick-place-v2', orignal_env.SawyerPickPlaceEnvV2),
    ('plate-slide-v2', orignal_env.SawyerPlateSlideEnvV2),
    ('plate-slide-side-v2', orignal_env.SawyerPlateSlideSideEnvV2),
    ('plate-slide-back-v2', orignal_env.SawyerPlateSlideBackEnvV2),
    ('plate-slide-back-side-v2', orignal_env.SawyerPlateSlideBackSideEnvV2),
    ('peg-insert-side-v2', orignal_env.SawyerPegInsertionSideEnvV2),
    ('peg-unplug-side-v2', orignal_env.SawyerPegUnplugSideEnvV2),
    ('soccer-v2', orignal_env.SawyerSoccerEnvV2),
    ('stick-push-v2', orignal_env.SawyerStickPushEnvV2),
    ('stick-pull-v2', orignal_env.SawyerStickPullEnvV2),
    ('push-wall-v2', orignal_env.SawyerPushWallEnvV2),
    ('push-v2', orignal_env.SawyerPushEnvV2),
    ('reach-wall-v2', orignal_env.SawyerReachWallEnvV2),
    ('reach-v2', orignal_env.SawyerReachEnvV2),
    ('shelf-place-v2', orignal_env.SawyerShelfPlaceEnvV2),
    ('sweep-into-v2', orignal_env.SawyerSweepIntoGoalEnvV2),
    ('sweep-v2', orignal_env.SawyerSweepEnvV2),
    ('window-open-v2', orignal_env.SawyerWindowOpenEnvV2),
    ('window-close-v2', orignal_env.SawyerWindowCloseEnvV2),
    ('sample', orignal_env.SawyerSampleEnvV2),
))

ALL_V2_ENVIRONMENTS_multi = OrderedDict((
