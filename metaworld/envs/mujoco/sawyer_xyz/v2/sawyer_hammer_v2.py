...
class SawyerHammerEnvV2(SawyerXYZEnv):
    ...
    def __init__(self):
        ...
        obj_low = (main_env_pos, 0.4, 0.0)
        obj_high = (main_env_pos, 0.5, 0.0)
        goal_low = (main_env_pos+0.2399, .7399, 0.109)
        goal_high = (main_env_pos+0.2401, .7401, 0.111)
