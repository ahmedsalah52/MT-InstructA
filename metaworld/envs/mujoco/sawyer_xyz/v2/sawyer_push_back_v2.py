...
class SawyerPushBackEnvV2(SawyerXYZEnv):
    ...
    def __init__(self):
        ...
        hand_high = (0.5, 1, 0.5)
        main_file = 'sawyer_push_back_v2.xml'
        ...
        obj_low   = (main_env_pos, 0.8, 0.02)
        obj_high  = (main_env_pos, 0.85, 0.02)
        goal_low  = (main_env_pos-0.05, 0.6, 0.0199)
        goal_high = (main_env_pos+0.05, 0.7, 0.0201)
        super().__init__(
            self.model_name,
            hand_low=hand_low,
            hand_high=hand_high,
