...
class SawyerNutAssemblyEnvV2(SawyerXYZEnv):
    ...
    def __init__(self):        
        ...
        obj_low   = (multi_object.get_dx_low()  , 0.6, 0.02)
        obj_high  = (multi_object.get_dx_high() , 0.6, 0.02)
        goal_low  = (multi_object.get_dx_low(), 0.75, 0.1)
        goal_high = (multi_object.get_dx_high(), 0.85, 0.1)
        """
