...
class SawyerStickPullEnvV2(SawyerXYZEnv):
    def __init__(self):
        ...
        main_file = 'sawyer_stick_obj.xml'
        generate = False
        if generate:
        ...
        goal_low = (main_env_pos, 0.45, 0.0199)
        goal_high = (main_env_pos, 0.55, 0.0201)
        obj_low = (main_env_pos, 0.55, 0.000)
        obj_high = (main_env_pos, 0.65, 0.001)
        super().__init__(
            self.model_name,
            hand_low=hand_low,
            hand_high=hand_high,
