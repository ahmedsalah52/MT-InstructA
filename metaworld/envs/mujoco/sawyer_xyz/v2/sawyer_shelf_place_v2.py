...
class SawyerShelfPlaceEnvV2(SawyerXYZEnv):
    ...
    def __init__(self,main_pos_index=None , task_variant = None):
        ...
        hand_high = (0.6, 1, 0.5)
        main_file = 'sawyer_shelf_placing.xml'
        self.generate_env(main_file,main_pos_index,task_variant)


        obj_low   = (self.task_offsets_min[0]   ,self.task_offsets_min[1] + 0.5, 0.019)
        obj_high  = (self.task_offsets_max[0]   ,self.task_offsets_max[1] + 0.5, 0.021)
        goal_low  = (self.task_offsets_min[0]   ,self.task_offsets_min[1] + 0.8, 0.299)
        goal_high = (self.task_offsets_max[0]   ,self.task_offsets_max[1] + 0.8, 0.301)
        super().__init__(
            self.model_name,
            hand_low=hand_low,
            hand_high=hand_high,
