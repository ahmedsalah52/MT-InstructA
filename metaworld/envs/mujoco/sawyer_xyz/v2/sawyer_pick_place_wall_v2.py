...
class SawyerPickPlaceWallEnvV2(SawyerXYZEnv):
    ...
    def __init__(self):
        ...
        main_file = 'sawyer_pick_place_wall_v2'
        ...
        hand_low = (main_env_pos, 0.40, 0.05)
        hand_high = (main_env_pos, 1, 0.5)
        obj_low = (main_env_pos-0.05, 0.6, 0.015)
        obj_high = (main_env_pos+0.05, 0.65, 0.015)
