...
class SawyerHandlePressEnvV2(SawyerXYZEnv):
    ...
    def __init__(self,main_pos_index=None , task_variant = None):
        ...
        obj_low   = (self.task_offsets_min[0]   ,self.task_offsets_min[1] + 0.9, -0.001)
        obj_high  = (self.task_offsets_max[0]   ,self.task_offsets_max[1] + 0.9, +0.001)
        goal_low  = (self.task_offsets_min[0]   ,self.task_offsets_min[1] +0.55, 0.04)
        goal_high = (self.task_offsets_max[0]   ,self.task_offsets_max[1] +0.55, 0.08)
