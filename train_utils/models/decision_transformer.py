...
class DecisionTransformer(TrajectoryModel):
    ...
    def forward(self, states, actions, poses, command, timesteps, attention_mask=None):
        ...
        stacked_inputs = torch.stack(
            (pos_embeddings,command_embeddings, state_embeddings, action_embeddings), dim=1
        ...
        # pos (0), command (1), or state (2) , action (3); i.e. x[:,1,t] is the token for s_t
