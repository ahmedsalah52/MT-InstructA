...
dataset_tasks = ['button-press-topdown-v2', 'button-press-v2', 'door-lock-v2',  'door-open-v2', 'drawer-open-v2', 'window-open-v2', 'faucet-open-v2', 'faucet-close-v2', 'handle-press-v2', 'coffee-button-v2']
#dataset_tasks = ['button-press-topdown-v2']
for taskname in dataset_tasks:#tasks:#ALL_V2_ENVIRONMENTS.keys():
    ...
    multi = True
    pos = 1
    variant = None# ['faucet','window_horizontal','button_press_topdown']
